...
"""
Autobuild sub-command to appropriately configure a repository with cmake.
...
class PlatformSetup(object):
    ...
    def build_dirs(self):
        ...
        # find the location of the nearest autobuild.xml file
        conf = configfile.ConfigFile()
        if not conf.load():
            raise AutobuildError("Cannot find config file: %s" % configfile.AUTOBUILD_CONFIG_FILE)
